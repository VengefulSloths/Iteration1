...
public abstract class ViewManager extends JPanel {
    ...
    protected static final int MAIN_PANEL_WIDTH = (int) Config.instance().getMainPanelWidth();
    protected static final int MAIN_PANEL_HEIGHT = (int) Config.instance().getMainPanelHeight();
